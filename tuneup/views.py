...
from .forms import UserLoginForm, RegistrationForm, ResetPasswordForm
...
def login_request(request):
    ...
    return render(request, 'musicapp/login.html', context=context)
...
def signup_request(request):
    ...
    return render(request, 'musicapp/signup.html', context=context)
...
def reset_password(request):
    ...
    return render(request, 'musicapp/password_reset.html', context)
